...
class RentalApartmentList {
     ...
     * 賃貸アパートの配列
     */
    RentalApartment[] apartments = new RentalApartment[MAX_QUANTITY];
     ...
     */
    void addRentalApartment(RentalApartment apartment) {
     ...
     */
    RentalApartment getRentalApartment(int index) {
        // 引数で指定されたインデックスが
